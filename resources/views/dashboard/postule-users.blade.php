            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach($applications as $application)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $application->last_name }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $application->first_name }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $application->jobOffer->title }}</td>
