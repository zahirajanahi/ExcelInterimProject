...
@section('content')
    ...
    <div class="flex space-x-36 mt-32 items-center ">
        ...
        {{-- left side --}}
        <div>
            <div class="bg-fixed bg-cover bg-center h-[40vh] w-[60vw] object-cover rounded-2xl" style="background-image: url('{{ asset('storage/images/recrutement.avif') }}')">
                <div class="h-full w-full flex items-center justify-center bg-black bg-opacity-40 rounded-2xl">
                    <h1 class="text-white text-4xl font-bold">Recrutement</h1>
                </div>
            </div>
            <p class="w-[60vw] text-gray-800 leading-relaxed pt-7">
                Notre équipe passionnée et dévouée est là pour vous accompagner dans tous vos projets professionnels. Nous mettons l'accent sur la création de relations durables basées sur la confiance mutuelle et le respect.
    
                Chez Excel Interim , la flexibilité est au cœur de notre approche. Nous comprenons les défis auxquels font face les entreprises d'aujourd'hui et nous nous efforçons de fournir des solutions adaptées à vos besoins spécifiques.
                
                Notre objectif est de fournir des talents compétents et qualifiés qui s'intègrent parfaitement dans votre entreprise. La sécurité et le bien-être de nos collaborateurs sont également une priorité absolue.
                
                Nous sommes fiers de contribuer à votre développement professionnel et nous sommes convaincus que notre collaboration sera mutuellement bénéfique.
            </p>
        </div>
      </div>
    ...
    <section class="splide ms-5 mt-32 " id="secteurs-carousel">
        <h1 class="text-[#c01c2e] text-4xl font-bold text-center">Nos Secteurs D'activité</h1>
