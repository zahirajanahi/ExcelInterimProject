        ...
        <div class="container mx-auto flex justify-between items-center p-1">
            ...
            <ul class="flex space-x-6 items-center">
                <li class="relative group z-50">
                    <a href="{{ url('/') }}" class="dropdown-btn text-black font-semibold hover:text-[#c01c2e] hover:bg-zinc-300  transition duration-700 px-4 py-2 rounded-3xl">
                        RHS EMPLOI
                    </a>
                ...
                <li class="relative group">
                    <a href="{{ url('/travailT') }}" class="dropdown-btn text-gray-800 font-semibold hover:text-[#c01c2e] hover:bg-zinc-300 transition duration-700 px-4 py-2 rounded-3xl">
                        Nos services
                    </a>
                    <ul class="dropdown-menu absolute left-0 mt-4 w-[20vw] bg-white shadow-lg rounded-md py-2 opacity-0 invisible transition-all ease-in-out duration-300 transform scale-95 group-hover:opacity-100 group-hover:visible group-hover:scale-100">
                ...
                <li><a href="{{ url('/nosoffers') }}" class="text-gray-800 font-semibold hover:bg-zinc-300 hover:text-[#c01c2e] transition duration-700 px-4 py-2 rounded-3xl">Offres d'emploi</a></li>
